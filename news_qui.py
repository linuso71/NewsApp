...
class NewsApp:
    ...
    def __init__(self):
        ...
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=9d114f91f7a9410796356c3f965d8c51').json()
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://www.mobileslots4u.co.uk/wp-content/themes/mobileslots/images/loading-sign.jpg'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350, 250))
            photo = ImageTk.PhotoImage(im)
